...
export const integrationRegistry: IntegrationDefinition[] = [
  ...
  { id: "ga4", name: "Google Analytics 4", category: "Analytics", phase: "grow", requiredEnv: ["VITE_GA4_MEASUREMENT_ID"], notes: "Web acquisition measurement only; Amplitude is the canonical product/revenue lifecycle truth." },
  { id: "clarity", name: "Microsoft Clarity", category: "Analytics", phase: "improve", requiredEnv: ["VITE_CLARITY_PROJECT_ID"], notes: "Session diagnostics with privacy controls; not a revenue source of truth." },
  { id: "amplitude", name: "Amplitude", category: "Analytics", phase: "validate", requiredEnv: ["VITE_AMPLITUDE_API_KEY"], notes: "Canonical StreamVista product/revenue lifecycle analytics: Creator → Content → Rights → QC → Buyer → Deal → Contract → Delivery → Revenue → Settlement." },
